...
#define FAILE_NAME	"data\\TEXT\\umamotion2.txt"	// 読み込むtext名
#define UMA_SPEED	(1.01f)
//=============================================================================
// 変数
//=============================================================================
CHorse2::KEY CHorse2::m_aKeyOffset[MAX_PARTS] = {};

int	CHorse2::m_nNumParts = {};
int	CHorse2::m_nNumModel = {};
CMeshOrbit*CHorse2::m_mesh;
CHorse2::KEY_INFO*CHorse2::m_pKeyInfo[MAX_PARTS] = {};
CHorse2::MOTION_INFO CHorse2::m_aMotionInfo[MAX_PARTS] = {};

//=============================================================================
// 静的メンバ-変数宣言
//=============================================================================
LPDIRECT3DTEXTURE9 CHorse2::m_pTexture = NULL;				// テクスチャ
LPD3DXBUFFER CHorse2::m_pBuffMatModel[MAX_PARTS] = {};		// バッファ
DWORD CHorse2::m_nNumMatModel[MAX_PARTS] = {};			    // マテリアル情報の数
LPD3DXMESH CHorse2::m_pMeshModel[MAX_PARTS] = {};			// メッシュ情報へのポインタ
D3DXVECTOR3	CHorse2::m_pos = D3DXVECTOR3(0, 0, 0);			// 位置
D3DXVECTOR3 CHorse2::m_rot = D3DXVECTOR3(0, 0, 0);			// 向き
char CHorse2::m_aFileNameModel[MAX_PARTS][256] = {};
CModel*CHorse2::m_apModel[MAX_PARTS] = {};
int CHorse2::m_aIndexParent[MAX_PARTS] = {};
CHorse2::PLAYERSTATE CHorse2::m_State = CHorse2::PLAYERSTATE_NONE;
CHorse2::JOCKEYTYPE CHorse2::m_nType = CHorse2::JOCKEYTYPE_NONE;

//=============================================================================
// 読み込み
//=============================================================================
HRESULT CHorse2::Load(void)
{
	// デバイスを取得
...
// コンストラクタ
//=============================================================================
CHorse2::CHorse2(int nPriority, OBJTYPE objtype) :CScene(1, OBJTYPE_PLAYER)
{
	m_nCntA = 0;
	m_nCntB = 0;
	...
	m_State = CHorse2::PLAYERSTATE_NONE;
	m_nMotionType = 0;
}
...
// プレイヤーの生成
//=============================================================================
CHorse2 *CHorse2::Create(D3DXVECTOR3 pos, D3DXVECTOR3 rot, CHorse2::JOCKEYTYPE type)
{
	CHorse2 *pPlayer = NULL;

	if (pPlayer == NULL)
	{
		pPlayer = new CHorse2(1);
...
// プレイヤーのポジション取得
//=============================================================================
D3DXVECTOR3 CHorse2::GetPlayerpos(D3DXVECTOR3 pos)
{
	m_pos = pos;
...
// プレイヤーの位置取得
//=============================================================================
D3DXVECTOR3 CHorse2::Getpos(void)
{
	return m_pos;
}
...
// プレイヤーの向き取得
//=============================================================================
D3DXVECTOR3 CHorse2::Getrot(void)
{
	return m_rot;
}
...
// プレイヤーの動き取得
//=============================================================================
D3DXVECTOR3 CHorse2::Getmove(void)
{
	return m_move;
}
...
// モーションの更新処理
//=============================================================================
void CHorse2::UpdateMotion(void)
{
...
// 1行分(256)の読み込み
//=============================================================================
char * CHorse2::ReadLine(FILE *pFile, char * pDest)
{
	// 1行分(256文字分)読み込み)
	while (1)
	{// 有効な文字列が見つかるまで回す
...
// 文字列の先頭を取得
//=============================================================================
char * CHorse2::GetLineTop(char * pSrc)
{
	while (1)
	{// 有効な文字列が見つかるまで回す
...
// 文字列を抜き出す
//=============================================================================
int CHorse2::PopString(char * pSrc, char * pDest)
{
	int Word = 0;
