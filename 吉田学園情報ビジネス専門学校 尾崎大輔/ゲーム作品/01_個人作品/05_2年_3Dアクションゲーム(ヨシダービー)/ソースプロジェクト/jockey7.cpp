...
#define JOCKEY_SPEED	(0.77f)

//=============================================================================
// 変数
//=============================================================================
CJockey7::KEY CJockey7::m_aKeyOffset[MAX_PARTS] = {};

int	CJockey7::m_nNumParts = {};
int	CJockey7::m_nNumModel = {};
CMeshOrbit*CJockey7::m_mesh;
CJockey7::KEY_INFO*CJockey7::m_pKeyInfo[MAX_PARTS] = {};
CJockey7::MOTION_INFO CJockey7::m_aMotionInfo[MAX_PARTS] = {};

//=============================================================================
// 静的メンバ-変数宣言
//=============================================================================
LPDIRECT3DTEXTURE9 CJockey7::m_pTexture = NULL;				// テクスチャ
LPD3DXBUFFER CJockey7::m_pBuffMatModel[MAX_PARTS] = {};		// バッファ
DWORD CJockey7::m_nNumMatModel[MAX_PARTS] = {};			    // マテリアル情報の数
LPD3DXMESH CJockey7::m_pMeshModel[MAX_PARTS] = {};			// メッシュ情報へのポインタ
D3DXVECTOR3	CJockey7::m_pos = D3DXVECTOR3(0, 0, 0);			// 位置
D3DXVECTOR3 CJockey7::m_rot = D3DXVECTOR3(0, 0, 0);			// 向き
char CJockey7::m_aFileNameModel[MAX_PARTS][256] = {};
CModel*CJockey7::m_apModel[MAX_PARTS] = {};
int CJockey7::m_aIndexParent[MAX_PARTS] = {};
CJockey7::JOCKEYSTATE CJockey7::m_State = CJockey7::JOCKEYSTATE_NONE;
CJockey7::JOCKEYTYPE CJockey7::m_nType = CJockey7::JOCKEYTYPE_NONE;

//=============================================================================
// 読み込み
//=============================================================================
HRESULT CJockey7::Load(void)
{
	// デバイスを取得
...
// コンストラクタ
//=============================================================================
CJockey7::CJockey7(int nPriority, OBJTYPE objtype) :CScene(1, OBJTYPE_PLAYER)
{
	m_nCntA = 0;
	m_nCntB = 0;
	...
	m_State = CJockey7::JOCKEYSTATE_NONE;
	m_nMotionType = 0;
}
...
void CJockey7::Update(void)
{
	...
	m_pos = CHorse7::Getpos();
	m_rot = CHorse7::Getrot();
...
// プレイヤーの生成
//=============================================================================
CJockey7 *CJockey7::Create(D3DXVECTOR3 pos, D3DXVECTOR3 rot, CJockey7::JOCKEYTYPE type)
{
	CJockey7 *pPlayer = NULL;

	if (pPlayer == NULL)
	{
		pPlayer = new CJockey7(1);
...
// プレイヤーのポジション取得
//=============================================================================
D3DXVECTOR3 CJockey7::GetPlayerpos(D3DXVECTOR3 pos)
{
	m_pos = pos;
...
// プレイヤーの位置取得
//=============================================================================
D3DXVECTOR3 CJockey7::Getpos(void)
{
	return m_pos;
}
...
// プレイヤーの向き取得
//=============================================================================
D3DXVECTOR3 CJockey7::Getrot(void)
{
	return m_rot;
}
...
// プレイヤーの動き取得
//=============================================================================
D3DXVECTOR3 CJockey7::Getmove(void)
{
	return m_move;
}
...
// モーションの更新処理
//=============================================================================
void CJockey7::UpdateMotion(void)
{
...
// 1行分(256)の読み込み
//=============================================================================
char * CJockey7::ReadLine(FILE *pFile, char * pDest)
{
	// 1行分(256文字分)読み込み)
	while (1)
	{// 有効な文字列が見つかるまで回す
...
// 文字列の先頭を取得
//=============================================================================
char * CJockey7::GetLineTop(char * pSrc)
{
	while (1)
	{// 有効な文字列が見つかるまで回す
...
// 文字列を抜き出す
//=============================================================================
int CJockey7::PopString(char * pSrc, char * pDest)
{
	int Word = 0;
