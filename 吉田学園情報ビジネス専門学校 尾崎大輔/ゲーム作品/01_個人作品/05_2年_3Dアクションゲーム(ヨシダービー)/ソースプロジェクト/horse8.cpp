...
#define FAILE_NAME	"data\\TEXT\\umamotion8.txt"	// 読み込むtext名
#define UMA_SPEED	(1.07f)
//=============================================================================
// 変数
//=============================================================================
CHorse8::KEY CHorse8::m_aKeyOffset[MAX_PARTS] = {};

int	CHorse8::m_nNumParts = {};
int	CHorse8::m_nNumModel = {};
CMeshOrbit*CHorse8::m_mesh;
CHorse8::KEY_INFO*CHorse8::m_pKeyInfo[MAX_PARTS] = {};
CHorse8::MOTION_INFO CHorse8::m_aMotionInfo[MAX_PARTS] = {};

//=============================================================================
// 静的メンバ-変数宣言
//=============================================================================
LPDIRECT3DTEXTURE9 CHorse8::m_pTexture = NULL;				// テクスチャ
LPD3DXBUFFER CHorse8::m_pBuffMatModel[MAX_PARTS] = {};		// バッファ
DWORD CHorse8::m_nNumMatModel[MAX_PARTS] = {};			    // マテリアル情報の数
LPD3DXMESH CHorse8::m_pMeshModel[MAX_PARTS] = {};			// メッシュ情報へのポインタ
D3DXVECTOR3	CHorse8::m_pos = D3DXVECTOR3(0, 0, 0);			// 位置
D3DXVECTOR3 CHorse8::m_rot = D3DXVECTOR3(0, 0, 0);			// 向き
char CHorse8::m_aFileNameModel[MAX_PARTS][256] = {};
CModel*CHorse8::m_apModel[MAX_PARTS] = {};
int CHorse8::m_aIndexParent[MAX_PARTS] = {};
CHorse8::PLAYERSTATE CHorse8::m_State = CHorse8::PLAYERSTATE_NONE;
CHorse8::JOCKEYTYPE CHorse8::m_nType = CHorse8::JOCKEYTYPE_NONE;

//=============================================================================
// 読み込み
//=============================================================================
HRESULT CHorse8::Load(void)
{
	// デバイスを取得
...
// コンストラクタ
//=============================================================================
CHorse8::CHorse8(int nPriority, OBJTYPE objtype) :CScene(1, OBJTYPE_PLAYER)
{
	m_nCntA = 0;
	m_nCntB = 0;
	...
	m_State = CHorse8::PLAYERSTATE_NONE;
	m_nMotionType = 0;
}
...
// プレイヤーの生成
//=============================================================================
CHorse8 *CHorse8::Create(D3DXVECTOR3 pos, D3DXVECTOR3 rot, CHorse8::JOCKEYTYPE type)
{
	CHorse8 *pPlayer = NULL;

	if (pPlayer == NULL)
	{
		pPlayer = new CHorse8(1);
...
// プレイヤーのポジション取得
//=============================================================================
D3DXVECTOR3 CHorse8::GetPlayerpos(D3DXVECTOR3 pos)
{
	m_pos = pos;
...
// プレイヤーの位置取得
//=============================================================================
D3DXVECTOR3 CHorse8::Getpos(void)
{
	return m_pos;
}
...
// プレイヤーの向き取得
//=============================================================================
D3DXVECTOR3 CHorse8::Getrot(void)
{
	return m_rot;
}
...
// プレイヤーの動き取得
//=============================================================================
D3DXVECTOR3 CHorse8::Getmove(void)
{
	return m_move;
}
...
// モーションの更新処理
//=============================================================================
void CHorse8::UpdateMotion(void)
{
...
// 1行分(256)の読み込み
//=============================================================================
char * CHorse8::ReadLine(FILE *pFile, char * pDest)
{
	// 1行分(256文字分)読み込み)
	while (1)
	{// 有効な文字列が見つかるまで回す
...
// 文字列の先頭を取得
//=============================================================================
char * CHorse8::GetLineTop(char * pSrc)
{
	while (1)
	{// 有効な文字列が見つかるまで回す
...
// 文字列を抜き出す
//=============================================================================
int CHorse8::PopString(char * pSrc, char * pDest)
{
	int Word = 0;
