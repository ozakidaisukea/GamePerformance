...
#define JOCKEY_SPEED	(0.73f)
//=============================================================================
// 変数
//=============================================================================
CJockey3::KEY CJockey3::m_aKeyOffset[MAX_PARTS] = {};

int	CJockey3::m_nNumParts = {};
int	CJockey3::m_nNumModel = {};
CMeshOrbit*CJockey3::m_mesh;
CJockey3::KEY_INFO*CJockey3::m_pKeyInfo[MAX_PARTS] = {};
CJockey3::MOTION_INFO CJockey3::m_aMotionInfo[MAX_PARTS] = {};

//=============================================================================
// 静的メンバ-変数宣言
//=============================================================================
LPDIRECT3DTEXTURE9 CJockey3::m_pTexture = NULL;				// テクスチャ
LPD3DXBUFFER CJockey3::m_pBuffMatModel[MAX_PARTS] = {};		// バッファ
DWORD CJockey3::m_nNumMatModel[MAX_PARTS] = {};			    // マテリアル情報の数
LPD3DXMESH CJockey3::m_pMeshModel[MAX_PARTS] = {};			// メッシュ情報へのポインタ
D3DXVECTOR3	CJockey3::m_pos = D3DXVECTOR3(0, 0, 0);			// 位置
D3DXVECTOR3 CJockey3::m_rot = D3DXVECTOR3(0, 0, 0);			// 向き
char CJockey3::m_aFileNameModel[MAX_PARTS][256] = {};
CModel*CJockey3::m_apModel[MAX_PARTS] = {};
int CJockey3::m_aIndexParent[MAX_PARTS] = {};
CJockey3::JOCKEYSTATE CJockey3::m_State = CJockey3::JOCKEYSTATE_NONE;
CJockey3::JOCKEYTYPE CJockey3::m_nType = CJockey3::JOCKEYTYPE_NONE;
//=============================================================================
// 読み込み
//=============================================================================
HRESULT CJockey3::Load(void)
{
	// デバイスを取得
...
// コンストラクタ
//=============================================================================
CJockey3::CJockey3(int nPriority, OBJTYPE objtype) :CScene(1, OBJTYPE_PLAYER)
{
	m_nCntA = 0;
	m_nCntB = 0;
	...
	m_State = CJockey3::JOCKEYSTATE_NONE;
	m_nMotionType = 0;
}
...
void CJockey3::Update(void)
{
	...
	m_pos = CHorse3::Getpos();
	m_rot = CHorse3::Getrot();
...
// プレイヤーの生成
//=============================================================================
CJockey3 *CJockey3::Create(D3DXVECTOR3 pos, D3DXVECTOR3 rot, CJockey3::JOCKEYTYPE type)
{
	CJockey3 *pPlayer = NULL;

	if (pPlayer == NULL)
	{
		pPlayer = new CJockey3(1);
...
// プレイヤーのポジション取得
//=============================================================================
D3DXVECTOR3 CJockey3::GetPlayerpos(D3DXVECTOR3 pos)
{
	m_pos = pos;
...
// プレイヤーの位置取得
//=============================================================================
D3DXVECTOR3 CJockey3::Getpos(void)
{
	return m_pos;
}
...
// プレイヤーの向き取得
//=============================================================================
D3DXVECTOR3 CJockey3::Getrot(void)
{
	return m_rot;
}
...
// プレイヤーの動き取得
//=============================================================================
D3DXVECTOR3 CJockey3::Getmove(void)
{
	return m_move;
}
...
// モーションの更新処理
//=============================================================================
void CJockey3::UpdateMotion(void)
{
...
// 1行分(256)の読み込み
//=============================================================================
char * CJockey3::ReadLine(FILE *pFile, char * pDest)
{
	// 1行分(256文字分)読み込み)
	while (1)
	{// 有効な文字列が見つかるまで回す
...
// 文字列の先頭を取得
//=============================================================================
char * CJockey3::GetLineTop(char * pSrc)
{
	while (1)
	{// 有効な文字列が見つかるまで回す
...
// 文字列を抜き出す
//=============================================================================
int CJockey3::PopString(char * pSrc, char * pDest)
{
	int Word = 0;
