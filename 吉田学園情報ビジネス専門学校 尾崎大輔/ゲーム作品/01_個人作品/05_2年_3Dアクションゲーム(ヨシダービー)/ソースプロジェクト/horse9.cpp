...
#define FAILE_NAME	"data\\TEXT\\umamotion9.txt"	// 読み込むtext名
#define UMA_SPEED	(1.08f)
//=============================================================================
// 変数
//=============================================================================
CHorse9::KEY CHorse9::m_aKeyOffset[MAX_PARTS] = {};

int	CHorse9::m_nNumParts = {};
int	CHorse9::m_nNumModel = {};
CMeshOrbit*CHorse9::m_mesh;
CHorse9::KEY_INFO*CHorse9::m_pKeyInfo[MAX_PARTS] = {};
CHorse9::MOTION_INFO CHorse9::m_aMotionInfo[MAX_PARTS] = {};

//=============================================================================
// 静的メンバ-変数宣言
//=============================================================================
LPDIRECT3DTEXTURE9 CHorse9::m_pTexture = NULL;				// テクスチャ
LPD3DXBUFFER CHorse9::m_pBuffMatModel[MAX_PARTS] = {};		// バッファ
DWORD CHorse9::m_nNumMatModel[MAX_PARTS] = {};			    // マテリアル情報の数
LPD3DXMESH CHorse9::m_pMeshModel[MAX_PARTS] = {};			// メッシュ情報へのポインタ
D3DXVECTOR3	CHorse9::m_pos = D3DXVECTOR3(0, 0, 0);			// 位置
D3DXVECTOR3 CHorse9::m_rot = D3DXVECTOR3(0, 0, 0);			// 向き
char CHorse9::m_aFileNameModel[MAX_PARTS][256] = {};
CModel*CHorse9::m_apModel[MAX_PARTS] = {};
int CHorse9::m_aIndexParent[MAX_PARTS] = {};
CHorse9::PLAYERSTATE CHorse9::m_State = CHorse9::PLAYERSTATE_NONE;
CHorse9::JOCKEYTYPE CHorse9::m_nType = CHorse9::JOCKEYTYPE_NONE;

//=============================================================================
// 読み込み
//=============================================================================
HRESULT CHorse9::Load(void)
{
	// デバイスを取得
...
// コンストラクタ
//=============================================================================
CHorse9::CHorse9(int nPriority, OBJTYPE objtype) :CScene(1, OBJTYPE_PLAYER)
{
	m_nCntA = 0;
	m_nCntB = 0;
	...
	m_State = CHorse9::PLAYERSTATE_NONE;
	m_nMotionType = 0;
}
...
// プレイヤーの生成
//=============================================================================
CHorse9 *CHorse9::Create(D3DXVECTOR3 pos, D3DXVECTOR3 rot, CHorse9::JOCKEYTYPE type)
{
	CHorse9 *pPlayer = NULL;

	if (pPlayer == NULL)
	{
		pPlayer = new CHorse9(1);
...
// プレイヤーのポジション取得
//=============================================================================
D3DXVECTOR3 CHorse9::GetPlayerpos(D3DXVECTOR3 pos)
{
	m_pos = pos;
...
// プレイヤーの位置取得
//=============================================================================
D3DXVECTOR3 CHorse9::Getpos(void)
{
	return m_pos;
}
...
// プレイヤーの向き取得
//=============================================================================
D3DXVECTOR3 CHorse9::Getrot(void)
{
	return m_rot;
}
...
// プレイヤーの動き取得
//=============================================================================
D3DXVECTOR3 CHorse9::Getmove(void)
{
	return m_move;
}
...
// モーションの更新処理
//=============================================================================
void CHorse9::UpdateMotion(void)
{
...
// 1行分(256)の読み込み
//=============================================================================
char * CHorse9::ReadLine(FILE *pFile, char * pDest)
{
	// 1行分(256文字分)読み込み)
	while (1)
	{// 有効な文字列が見つかるまで回す
...
// 文字列の先頭を取得
//=============================================================================
char * CHorse9::GetLineTop(char * pSrc)
{
	while (1)
	{// 有効な文字列が見つかるまで回す
...
// 文字列を抜き出す
//=============================================================================
int CHorse9::PopString(char * pSrc, char * pDest)
{
	int Word = 0;
