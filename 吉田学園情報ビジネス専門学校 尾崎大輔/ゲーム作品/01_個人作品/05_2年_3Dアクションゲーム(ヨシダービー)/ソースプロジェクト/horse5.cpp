...
#define FAILE_NAME	"data\\TEXT\\umamotion5.txt"	// 読み込むtext名
#define UMA_SPEED	(1.04f)
//=============================================================================
// 変数
//=============================================================================
CHorse5::KEY CHorse5::m_aKeyOffset[MAX_PARTS] = {};

int	CHorse5::m_nNumParts = {};
int	CHorse5::m_nNumModel = {};
CMeshOrbit*CHorse5::m_mesh;
CHorse5::KEY_INFO*CHorse5::m_pKeyInfo[MAX_PARTS] = {};
CHorse5::MOTION_INFO CHorse5::m_aMotionInfo[MAX_PARTS] = {};

//=============================================================================
// 静的メンバ-変数宣言
//=============================================================================
LPDIRECT3DTEXTURE9 CHorse5::m_pTexture = NULL;				// テクスチャ
LPD3DXBUFFER CHorse5::m_pBuffMatModel[MAX_PARTS] = {};		// バッファ
DWORD CHorse5::m_nNumMatModel[MAX_PARTS] = {};			    // マテリアル情報の数
LPD3DXMESH CHorse5::m_pMeshModel[MAX_PARTS] = {};			// メッシュ情報へのポインタ
D3DXVECTOR3	CHorse5::m_pos = D3DXVECTOR3(0, 0, 0);			// 位置
D3DXVECTOR3 CHorse5::m_rot = D3DXVECTOR3(0, 0, 0);			// 向き
char CHorse5::m_aFileNameModel[MAX_PARTS][256] = {};
CModel*CHorse5::m_apModel[MAX_PARTS] = {};
int CHorse5::m_aIndexParent[MAX_PARTS] = {};
CHorse5::PLAYERSTATE CHorse5::m_State = CHorse5::PLAYERSTATE_NONE;
CHorse5::JOCKEYTYPE CHorse5::m_nType = CHorse5::JOCKEYTYPE_NONE;

//=============================================================================
// 読み込み
//=============================================================================
HRESULT CHorse5::Load(void)
{
	// デバイスを取得
...
// コンストラクタ
//=============================================================================
CHorse5::CHorse5(int nPriority, OBJTYPE objtype) :CScene(1, OBJTYPE_PLAYER)
{
	m_nCntA = 0;
	m_nCntB = 0;
	...
	m_State = CHorse5::PLAYERSTATE_NONE;
	m_nMotionType = 0;
	m_Titlecnt = 0;
}
...
// プレイヤーの生成
//=============================================================================
CHorse5 *CHorse5::Create(D3DXVECTOR3 pos, D3DXVECTOR3 rot, CHorse5::JOCKEYTYPE type)
{
	CHorse5 *pPlayer = NULL;

	if (pPlayer == NULL)
	{
		pPlayer = new CHorse5(1);
...
// プレイヤーのポジション取得
//=============================================================================
D3DXVECTOR3 CHorse5::GetPlayerpos(D3DXVECTOR3 pos)
{
	m_pos = pos;
...
// プレイヤーの位置取得
//=============================================================================
D3DXVECTOR3 CHorse5::Getpos(void)
{
	return m_pos;
}
...
// プレイヤーの向き取得
//=============================================================================
D3DXVECTOR3 CHorse5::Getrot(void)
{
	return m_rot;
}
...
// プレイヤーの動き取得
//=============================================================================
D3DXVECTOR3 CHorse5::Getmove(void)
{
	return m_move;
}
...
// モーションの更新処理
//=============================================================================
void CHorse5::UpdateMotion(void)
{
...
// 1行分(256)の読み込み
//=============================================================================
char * CHorse5::ReadLine(FILE *pFile, char * pDest)
{
	// 1行分(256文字分)読み込み)
	while (1)
	{// 有効な文字列が見つかるまで回す
...
// 文字列の先頭を取得
//=============================================================================
char * CHorse5::GetLineTop(char * pSrc)
{
	while (1)
	{// 有効な文字列が見つかるまで回す
...
// 文字列を抜き出す
//=============================================================================
int CHorse5::PopString(char * pSrc, char * pDest)
{
	int Word = 0;
