...
#define FAILE_NAME	"data\\TEXT\\umamotion3.txt"	// 読み込むtext名
#define UMA_SPEED	(1.02f)
//=============================================================================
// 変数
//=============================================================================
CHorse3::KEY CHorse3::m_aKeyOffset[MAX_PARTS] = {};

int	CHorse3::m_nNumParts = {};
int	CHorse3::m_nNumModel = {};
CMeshOrbit*CHorse3::m_mesh;
CHorse3::KEY_INFO*CHorse3::m_pKeyInfo[MAX_PARTS] = {};
CHorse3::MOTION_INFO CHorse3::m_aMotionInfo[MAX_PARTS] = {};

//=============================================================================
// 静的メンバ-変数宣言
//=============================================================================
LPDIRECT3DTEXTURE9 CHorse3::m_pTexture = NULL;				// テクスチャ
LPD3DXBUFFER CHorse3::m_pBuffMatModel[MAX_PARTS] = {};		// バッファ
DWORD CHorse3::m_nNumMatModel[MAX_PARTS] = {};			    // マテリアル情報の数
LPD3DXMESH CHorse3::m_pMeshModel[MAX_PARTS] = {};			// メッシュ情報へのポインタ
D3DXVECTOR3	CHorse3::m_pos = D3DXVECTOR3(0, 0, 0);			// 位置
D3DXVECTOR3 CHorse3::m_rot = D3DXVECTOR3(0, 0, 0);			// 向き
char CHorse3::m_aFileNameModel[MAX_PARTS][256] = {};
CModel*CHorse3::m_apModel[MAX_PARTS] = {};
int CHorse3::m_aIndexParent[MAX_PARTS] = {};
CHorse3::PLAYERSTATE CHorse3::m_State = CHorse3::PLAYERSTATE_NONE;
CHorse3::JOCKEYTYPE CHorse3::m_nType = CHorse3::JOCKEYTYPE_NONE;

//=============================================================================
// 読み込み
//=============================================================================
HRESULT CHorse3::Load(void)
{
	// デバイスを取得
...
// コンストラクタ
//=============================================================================
CHorse3::CHorse3(int nPriority, OBJTYPE objtype) :CScene(1, OBJTYPE_PLAYER)
{
	m_nCntA = 0;
	m_nCntB = 0;
	...
	m_State = CHorse3::PLAYERSTATE_NONE;
	m_nMotionType = 0;
}
...
// プレイヤーの生成
//=============================================================================
CHorse3 *CHorse3::Create(D3DXVECTOR3 pos, D3DXVECTOR3 rot, CHorse3::JOCKEYTYPE type)
{
	CHorse3 *pPlayer = NULL;

	if (pPlayer == NULL)
	{
		pPlayer = new CHorse3(1);
...
// プレイヤーのポジション取得
//=============================================================================
D3DXVECTOR3 CHorse3::GetPlayerpos(D3DXVECTOR3 pos)
{
	m_pos = pos;
...
// プレイヤーの位置取得
//=============================================================================
D3DXVECTOR3 CHorse3::Getpos(void)
{
	return m_pos;
}
...
// プレイヤーの向き取得
//=============================================================================
D3DXVECTOR3 CHorse3::Getrot(void)
{
	return m_rot;
}
...
// プレイヤーの動き取得
//=============================================================================
D3DXVECTOR3 CHorse3::Getmove(void)
{
	return m_move;
}
...
// モーションの更新処理
//=============================================================================
void CHorse3::UpdateMotion(void)
{
...
// 1行分(256)の読み込み
//=============================================================================
char * CHorse3::ReadLine(FILE *pFile, char * pDest)
{
	// 1行分(256文字分)読み込み)
	while (1)
	{// 有効な文字列が見つかるまで回す
...
// 文字列の先頭を取得
//=============================================================================
char * CHorse3::GetLineTop(char * pSrc)
{
	while (1)
	{// 有効な文字列が見つかるまで回す
...
// 文字列を抜き出す
//=============================================================================
int CHorse3::PopString(char * pSrc, char * pDest)
{
	int Word = 0;
