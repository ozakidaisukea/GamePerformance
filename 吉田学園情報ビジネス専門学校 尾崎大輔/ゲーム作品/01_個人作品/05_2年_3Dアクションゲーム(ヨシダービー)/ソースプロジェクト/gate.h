...
public:
	...
	CGate(int nPriority = 1, OBJTYPE objtype = OBJTYPE_PLAYER);
	~CGate();
	...
	void	Draw(void);									// 描画処理
	static CGate *Create(D3DXVECTOR3 pos,GATE_TYPE type);// 生成処理
