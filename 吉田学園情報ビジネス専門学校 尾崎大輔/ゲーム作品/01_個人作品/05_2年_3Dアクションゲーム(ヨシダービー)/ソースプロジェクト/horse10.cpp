...
#define FAILE_NAME	"data\\TEXT\\umamotion10.txt"	// 読み込むtext名
#define UMA_SPEED	(1.09f)
//=============================================================================
// 変数
//=============================================================================
CHorse10::KEY CHorse10::m_aKeyOffset[MAX_PARTS] = {};

int	CHorse10::m_nNumParts = {};
int	CHorse10::m_nNumModel = {};
CMeshOrbit*CHorse10::m_mesh;
CHorse10::KEY_INFO*CHorse10::m_pKeyInfo[MAX_PARTS] = {};
CHorse10::MOTION_INFO CHorse10::m_aMotionInfo[MAX_PARTS] = {};

//=============================================================================
// 静的メンバ-変数宣言
//=============================================================================
LPDIRECT3DTEXTURE9 CHorse10::m_pTexture = NULL;				// テクスチャ
LPD3DXBUFFER CHorse10::m_pBuffMatModel[MAX_PARTS] = {};		// バッファ
DWORD CHorse10::m_nNumMatModel[MAX_PARTS] = {};			    // マテリアル情報の数
LPD3DXMESH CHorse10::m_pMeshModel[MAX_PARTS] = {};			// メッシュ情報へのポインタ
D3DXVECTOR3	CHorse10::m_pos = D3DXVECTOR3(0, 0, 0);			// 位置
D3DXVECTOR3 CHorse10::m_rot = D3DXVECTOR3(0, 0, 0);			// 向き
char CHorse10::m_aFileNameModel[MAX_PARTS][256] = {};
CModel*CHorse10::m_apModel[MAX_PARTS] = {};
int CHorse10::m_aIndexParent[MAX_PARTS] = {};
CHorse10::PLAYERSTATE CHorse10::m_State = CHorse10::PLAYERSTATE_NONE;
CHorse10::JOCKEYTYPE CHorse10::m_nType = CHorse10::JOCKEYTYPE_NONE;

//=============================================================================
// 読み込み
//=============================================================================
HRESULT CHorse10::Load(void)
{
	// デバイスを取得
...
// コンストラクタ
//=============================================================================
CHorse10::CHorse10(int nPriority, OBJTYPE objtype) :CScene(1, OBJTYPE_PLAYER)
{
	m_nCntA = 0;
	m_nCntB = 0;
	...
	m_State = CHorse10::PLAYERSTATE_NONE;
	m_nMotionType = 0;
}
...
// プレイヤーの生成
//=============================================================================
CHorse10 *CHorse10::Create(D3DXVECTOR3 pos, D3DXVECTOR3 rot, CHorse10::JOCKEYTYPE type)
{
	CHorse10 *pPlayer = NULL;

	if (pPlayer == NULL)
	{
		pPlayer = new CHorse10(1);
...
// プレイヤーのポジション取得
//=============================================================================
D3DXVECTOR3 CHorse10::GetPlayerpos(D3DXVECTOR3 pos)
{
	m_pos = pos;
...
// プレイヤーの位置取得
//=============================================================================
D3DXVECTOR3 CHorse10::Getpos(void)
{
	return m_pos;
}
...
// プレイヤーの向き取得
//=============================================================================
D3DXVECTOR3 CHorse10::Getrot(void)
{
	return m_rot;
}
...
// プレイヤーの動き取得
//=============================================================================
D3DXVECTOR3 CHorse10::Getmove(void)
{
	return m_move;
}
	 ...
	 // 文字列の先頭を設定
		...
		else if (memcmp(pStrCur, "END_PARTSSET", strlen("END_PARTSSET")) == 0)
		{
			...
			m_apModel[nIndex] = CModel::Create(D3DXVECTOR3(
				...
				m_rot.z + m_aKeyOffset[nIndex].fRotX));
...
// モーションの更新処理
//=============================================================================
void CHorse10::UpdateMotion(void)
{
...
// 1行分(256)の読み込み
//=============================================================================
char * CHorse10::ReadLine(FILE *pFile, char * pDest)
{
	// 1行分(256文字分)読み込み)
	while (1)
	{// 有効な文字列が見つかるまで回す
...
// 文字列の先頭を取得
//=============================================================================
char * CHorse10::GetLineTop(char * pSrc)
{
	while (1)
	{// 有効な文字列が見つかるまで回す
...
// 文字列を抜き出す
//=============================================================================
int CHorse10::PopString(char * pSrc, char * pDest)
{
	int Word = 0;
