...
#define FAILE_NAME	"data\\TEXT\\unionmotion.txt"	// 読み込むtext名

//=============================================================================
// 変数
//=============================================================================
CUnion::KEY CUnion::m_aKeyOffset[MAX_PARTS] = {};

int	CUnion::m_nNumParts = {};
int	CUnion::m_nNumModel = {};
CMeshOrbit*CUnion::m_mesh;
CUnion::KEY_INFO*CUnion::m_pKeyInfo[MAX_PARTS] = {};
CUnion::MOTION_INFO CUnion::m_aMotionInfo[MAX_PARTS] = {};

//=============================================================================
// 静的メンバ-変数宣言
//=============================================================================
LPDIRECT3DTEXTURE9 CUnion::m_pTexture = NULL;				// テクスチャ
LPD3DXBUFFER CUnion::m_pBuffMatModel[MAX_PARTS] = {};		// バッファ
DWORD CUnion::m_nNumMatModel[MAX_PARTS] = {};			    // マテリアル情報の数
LPD3DXMESH CUnion::m_pMeshModel[MAX_PARTS] = {};			// メッシュ情報へのポインタ
D3DXVECTOR3	CUnion::m_pos = D3DXVECTOR3(0, 0, 0);			// 位置
D3DXVECTOR3 CUnion::m_rot = D3DXVECTOR3(0, 0, 0);			// 向き
char CUnion::m_aFileNameModel[MAX_PARTS][256] = {};
CModel*CUnion::m_apModel[MAX_PARTS] = {};
int CUnion::m_aIndexParent[MAX_PARTS] = {};
CUnion::UNIONSTATE CUnion::m_State = CUnion::UNIONSTATE_NONE;

//=============================================================================
// 読み込み
//=============================================================================
HRESULT CUnion::Load(void)
{
	// デバイスを取得
...
// コンストラクタ
//=============================================================================
CUnion::CUnion(int nPriority, OBJTYPE objtype) :CScene(1, OBJTYPE_PLAYER)
{
	m_nCntA = 0;
	m_nCntB = 0;
	...
	m_State = CUnion::UNIONSTATE_NONE;
	m_nMotionType = 0;
}
...
void CUnion::Update(void)
{
	...
	{
		// メッシュフィールドの高さをプレイヤーに移行
		pMeshFiled->SetHigth(m_pos, 1.0f, 50);
	}
...
#ifdef _DEBUG
	// 範囲設定のデバック
	//m_Dubug->Print("ssfsfsf", "\n[ Player 位置 ] ", "X", m_pos.x, "Y", m_pos.y, "Z", m_pos.z);
#endif
}
...
// プレイヤーの生成
//=============================================================================
CUnion *CUnion::Create(D3DXVECTOR3 pos,D3DXVECTOR3 rot)
{
	CUnion *pUnion = NULL;
...
// プレイヤーのポジション取得
//=============================================================================
D3DXVECTOR3 CUnion::GetPlayerpos(D3DXVECTOR3 pos)
{
	m_pos = pos;
...
// プレイヤーの位置取得
//=============================================================================
D3DXVECTOR3 CUnion::Getpos(void)
{
	return m_pos;
}
...
// プレイヤーの向き取得
//=============================================================================
D3DXVECTOR3 CUnion::Getrot(void)
{
	return m_rot;
}
...
// プレイヤーの動き取得
//=============================================================================
D3DXVECTOR3 CUnion::Getmove(void)
{
	return m_move;
}
...
// 1行分(256)の読み込み
//=============================================================================
char * CUnion::ReadLine(FILE *pFile, char * pDest)
{
	// 1行分(256文字分)読み込み)
	while (1)
	{// 有効な文字列が見つかるまで回す
...
// 文字列の先頭を取得
//=============================================================================
char * CUnion::GetLineTop(char * pSrc)
{
	while (1)
	{// 有効な文字列が見つかるまで回す
...
// 文字列を抜き出す
//=============================================================================
int CUnion::PopString(char * pSrc, char * pDest)
{
	int Word = 0;
