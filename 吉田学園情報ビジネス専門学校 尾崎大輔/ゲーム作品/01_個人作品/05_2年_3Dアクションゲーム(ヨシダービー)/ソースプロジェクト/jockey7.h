...
public:
	...
	CJockey7(int nPriority = 1, OBJTYPE objtype = OBJTYPE_PLAYER);
	~CJockey7();
	...
	void	Draw(void);									// 描画処理
	static CJockey7 *Create(D3DXVECTOR3 pos, D3DXVECTOR3 rot, JOCKEYTYPE type);			// 生成処理
