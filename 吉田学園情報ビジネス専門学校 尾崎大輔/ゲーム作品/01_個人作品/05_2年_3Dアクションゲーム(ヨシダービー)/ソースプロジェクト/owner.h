...
public:
	...
	typedef enum
	{
		OWNERSTATE_NONE = 0,		//初期状態
		OWNERSTATE_NORMAL,			//通常
		OWNERSTATE_MAX,				//最大数
	}OWNERSTATE;
	...
	COwner(int nPriority = 1, OBJTYPE objtype = OBJTYPE_PLAYER);
	~COwner();
	...
	void	Draw(void);										// 描画処理
	static COwner *Create(D3DXVECTOR3 pos,D3DXVECTOR3 rot);	// 生成処理
