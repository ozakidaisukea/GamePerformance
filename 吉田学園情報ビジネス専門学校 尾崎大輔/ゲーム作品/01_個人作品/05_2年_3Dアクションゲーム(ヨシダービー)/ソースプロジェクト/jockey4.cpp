...
#define JOCKEY_SPEED	(0.74f)

//=============================================================================
// 変数
//=============================================================================
CJockey4::KEY CJockey4::m_aKeyOffset[MAX_PARTS] = {};

int	CJockey4::m_nNumParts = {};
int	CJockey4::m_nNumModel = {};
CMeshOrbit*CJockey4::m_mesh;
CJockey4::KEY_INFO*CJockey4::m_pKeyInfo[MAX_PARTS] = {};
CJockey4::MOTION_INFO CJockey4::m_aMotionInfo[MAX_PARTS] = {};

//=============================================================================
// 静的メンバ-変数宣言
//=============================================================================
LPDIRECT3DTEXTURE9 CJockey4::m_pTexture = NULL;				// テクスチャ
LPD3DXBUFFER CJockey4::m_pBuffMatModel[MAX_PARTS] = {};		// バッファ
DWORD CJockey4::m_nNumMatModel[MAX_PARTS] = {};			    // マテリアル情報の数
LPD3DXMESH CJockey4::m_pMeshModel[MAX_PARTS] = {};			// メッシュ情報へのポインタ
D3DXVECTOR3	CJockey4::m_pos = D3DXVECTOR3(0, 0, 0);			// 位置
D3DXVECTOR3 CJockey4::m_rot = D3DXVECTOR3(0, 0, 0);			// 向き
char CJockey4::m_aFileNameModel[MAX_PARTS][256] = {};
CModel*CJockey4::m_apModel[MAX_PARTS] = {};
int CJockey4::m_aIndexParent[MAX_PARTS] = {};
CJockey4::JOCKEYSTATE CJockey4::m_State = CJockey4::JOCKEYSTATE_NONE;
CJockey4::JOCKEYTYPE CJockey4::m_nType = CJockey4::JOCKEYTYPE_NONE;
//=============================================================================
// 読み込み
//=============================================================================
HRESULT CJockey4::Load(void)
{
	// デバイスを取得
...
// コンストラクタ
//=============================================================================
CJockey4::CJockey4(int nPriority, OBJTYPE objtype) :CScene(1, OBJTYPE_PLAYER)
{
	m_nCntA = 0;
	m_nCntB = 0;
	...
	m_State = CJockey4::JOCKEYSTATE_NONE;
	m_nMotionType = 0;
}
...
void CJockey4::Update(void)
{
	...
	m_pos = CHorse4::Getpos();
	m_rot = CHorse4::Getrot();
...
// プレイヤーの生成
//=============================================================================
CJockey4 *CJockey4::Create(D3DXVECTOR3 pos, D3DXVECTOR3 rot, CJockey4::JOCKEYTYPE type)
{
	CJockey4 *pPlayer = NULL;

	if (pPlayer == NULL)
	{
		pPlayer = new CJockey4(1);
...
// プレイヤーのポジション取得
//=============================================================================
D3DXVECTOR3 CJockey4::GetPlayerpos(D3DXVECTOR3 pos)
{
	m_pos = pos;
...
// プレイヤーの位置取得
//=============================================================================
D3DXVECTOR3 CJockey4::Getpos(void)
{
	return m_pos;
}
...
// プレイヤーの向き取得
//=============================================================================
D3DXVECTOR3 CJockey4::Getrot(void)
{
	return m_rot;
}
...
// プレイヤーの動き取得
//=============================================================================
D3DXVECTOR3 CJockey4::Getmove(void)
{
	return m_move;
}
...
// モーションの更新処理
//=============================================================================
void CJockey4::UpdateMotion(void)
{
...
// 1行分(256)の読み込み
//=============================================================================
char * CJockey4::ReadLine(FILE *pFile, char * pDest)
{
	// 1行分(256文字分)読み込み)
	while (1)
	{// 有効な文字列が見つかるまで回す
...
// 文字列の先頭を取得
//=============================================================================
char * CJockey4::GetLineTop(char * pSrc)
{
	while (1)
	{// 有効な文字列が見つかるまで回す
...
// 文字列を抜き出す
//=============================================================================
int CJockey4::PopString(char * pSrc, char * pDest)
{
	int Word = 0;
