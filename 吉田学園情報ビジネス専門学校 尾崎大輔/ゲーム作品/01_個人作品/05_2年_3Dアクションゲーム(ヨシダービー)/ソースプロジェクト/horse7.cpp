...
#define FAILE_NAME	"data\\TEXT\\umamotion7.txt"	// 読み込むtext名
#define UMA_SPEED	(1.06f)
//=============================================================================
// 変数
//=============================================================================
CHorse7::KEY CHorse7::m_aKeyOffset[MAX_PARTS] = {};

int	CHorse7::m_nNumParts = {};
int	CHorse7::m_nNumModel = {};
CMeshOrbit*CHorse7::m_mesh;
CHorse7::KEY_INFO*CHorse7::m_pKeyInfo[MAX_PARTS] = {};
CHorse7::MOTION_INFO CHorse7::m_aMotionInfo[MAX_PARTS] = {};

//=============================================================================
// 静的メンバ-変数宣言
//=============================================================================
LPDIRECT3DTEXTURE9 CHorse7::m_pTexture = NULL;				// テクスチャ
LPD3DXBUFFER CHorse7::m_pBuffMatModel[MAX_PARTS] = {};		// バッファ
DWORD CHorse7::m_nNumMatModel[MAX_PARTS] = {};			    // マテリアル情報の数
LPD3DXMESH CHorse7::m_pMeshModel[MAX_PARTS] = {};			// メッシュ情報へのポインタ
D3DXVECTOR3	CHorse7::m_pos = D3DXVECTOR3(0, 0, 0);			// 位置
D3DXVECTOR3 CHorse7::m_rot = D3DXVECTOR3(0, 0, 0);			// 向き
char CHorse7::m_aFileNameModel[MAX_PARTS][256] = {};
CModel*CHorse7::m_apModel[MAX_PARTS] = {};
int CHorse7::m_aIndexParent[MAX_PARTS] = {};
CHorse7::PLAYERSTATE CHorse7::m_State = CHorse7::PLAYERSTATE_NONE;
CHorse7::JOCKEYTYPE CHorse7::m_nType = CHorse7::JOCKEYTYPE_NONE;

//=============================================================================
// 読み込み
//=============================================================================
HRESULT CHorse7::Load(void)
{
	// デバイスを取得
...
// コンストラクタ
//=============================================================================
CHorse7::CHorse7(int nPriority, OBJTYPE objtype) :CScene(1, OBJTYPE_PLAYER)
{
	m_nCntA = 0;
	m_nCntB = 0;
	...
	m_State = CHorse7::PLAYERSTATE_NONE;
	m_nMotionType = 0;
}
...
// プレイヤーの生成
//=============================================================================
CHorse7 *CHorse7::Create(D3DXVECTOR3 pos, D3DXVECTOR3 rot, CHorse7::JOCKEYTYPE type)
{
	CHorse7 *pPlayer = NULL;

	if (pPlayer == NULL)
	{
		pPlayer = new CHorse7(1);
...
// プレイヤーのポジション取得
//=============================================================================
D3DXVECTOR3 CHorse7::GetPlayerpos(D3DXVECTOR3 pos)
{
	m_pos = pos;
...
// プレイヤーの位置取得
//=============================================================================
D3DXVECTOR3 CHorse7::Getpos(void)
{
	return m_pos;
}
...
// プレイヤーの向き取得
//=============================================================================
D3DXVECTOR3 CHorse7::Getrot(void)
{
	return m_rot;
}
...
// プレイヤーの動き取得
//=============================================================================
D3DXVECTOR3 CHorse7::Getmove(void)
{
	return m_move;
}
...
// モーションの更新処理
//=============================================================================
void CHorse7::UpdateMotion(void)
{
...
// 1行分(256)の読み込み
//=============================================================================
char * CHorse7::ReadLine(FILE *pFile, char * pDest)
{
	// 1行分(256文字分)読み込み)
	while (1)
	{// 有効な文字列が見つかるまで回す
...
// 文字列の先頭を取得
//=============================================================================
char * CHorse7::GetLineTop(char * pSrc)
{
	while (1)
	{// 有効な文字列が見つかるまで回す
...
// 文字列を抜き出す
//=============================================================================
int CHorse7::PopString(char * pSrc, char * pDest)
{
	int Word = 0;
