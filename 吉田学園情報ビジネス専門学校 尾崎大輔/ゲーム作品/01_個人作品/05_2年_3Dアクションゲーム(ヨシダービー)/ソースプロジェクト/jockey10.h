...
public:
	...
	CJockey10(int nPriority = 1, OBJTYPE objtype = OBJTYPE_PLAYER);
	~CJockey10();
	...
	void	Draw(void);									// 描画処理
	static CJockey10 *Create(D3DXVECTOR3 pos, D3DXVECTOR3 rot, JOCKEYTYPE type);			// 生成処理
