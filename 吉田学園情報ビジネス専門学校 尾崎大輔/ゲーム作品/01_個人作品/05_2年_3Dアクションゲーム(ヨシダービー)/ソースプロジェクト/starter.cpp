...
#define FAILE_NAME	"data\\TEXT\\startermotion.txt"	// 読み込むtext名

//=============================================================================
//グローバル変数
//=============================================================================
int g_nNumstaerterModel;
char g_aFileNamestarterModel[MAX_PARTS][256];

//=============================================================================
// 変数
//=============================================================================
CStarter::KEY CStarter::m_aKeyOffset[MAX_PARTS] = {};

int	CStarter::m_nNumParts = {};
int	CStarter::m_nNumModel = {};
CMeshOrbit*CStarter::m_mesh;
CStarter::KEY_INFO*CStarter::m_pKeyInfo[MAX_PARTS] = {};
CStarter::MOTION_INFO CStarter::m_aMotionInfo[MAX_PARTS] = {};

//=============================================================================
// 静的メンバ-変数宣言
//=============================================================================
LPDIRECT3DTEXTURE9 CStarter::m_pTexture = NULL;				// テクスチャ
LPD3DXBUFFER CStarter::m_pBuffMatModel[MAX_PARTS] = {};		// バッファ
DWORD CStarter::m_nNumMatModel[MAX_PARTS] = {};			    // マテリアル情報の数
LPD3DXMESH CStarter::m_pMeshModel[MAX_PARTS] = {};			// メッシュ情報へのポインタ
D3DXVECTOR3	CStarter::m_pos = D3DXVECTOR3(0, 0, 0);			// 位置
D3DXVECTOR3 CStarter::m_rot = D3DXVECTOR3(0, 0, 0);
char CStarter::m_aFileNameModel[MAX_PARTS][256] = {};
CModel*CStarter::m_apModel[MAX_PARTS] = {};
int CStarter::m_aIndexParent[MAX_PARTS] = {};
CStarter::STARTER CStarter::m_State = CStarter::STARTER_NONE;

//=============================================================================
// 読み込み
//=============================================================================
HRESULT CStarter::Load(void)
{
	// デバイスを取得
...
// 開放
//=============================================================================
void CStarter::Unload(void)
{
	for (int nCnt = 0; nCnt < NUM_STAERTER_MODEL; nCnt++)
	{
		// マテリアル情報へのポインタを破棄
...
// コンストラクタ
//=============================================================================
CStarter::CStarter(int nPriority, OBJTYPE objtype) :CScene(1, OBJTYPE_PLAYER)
{
	m_nCntA = 0;
	m_nCntB = 0;
	...
	m_State = CStarter::STARTER_NORMAL;
	m_nMotionType = 0;
}
...
#ifdef _DEBUG
	// 範囲設定のデバック
	m_Dubug->Print("ssfsfsf", "\n[ Starter 位置 ] ", "X", m_pos.x, "Y", m_pos.y, "Z", m_pos.z);
...
{
	CStarter *pStarter = NULL;

	if (pStarter == NULL)
	{
		pStarter = new CStarter(1);
...
// プレイヤーのポジション取得
//=============================================================================
D3DXVECTOR3 CStarter::GetPlayerpos(D3DXVECTOR3 pos)
{
	m_pos = pos;
...
// スターターの位置取得
//=============================================================================
D3DXVECTOR3 CStarter::Getpos(void)
{
	return m_pos;
}
...
// スターターの向き取得
//=============================================================================
D3DXVECTOR3 CStarter::Getrot(void)
{
	return m_rot;
}
...
// スターターの動き取得
//=============================================================================
D3DXVECTOR3 CStarter::Getmove(void)
{
	return m_move;
}
...
// モーションの更新処理
//=============================================================================
void CStarter::UpdateMotion(void)
{
...
// 1行分(256)の読み込み
//=============================================================================
char * CStarter::ReadLine(FILE *pFile, char * pDest)
{
	// 1行分(256文字分)読み込み)
	while (1)
	{// 有効な文字列が見つかるまで回す
...
// 文字列の先頭を取得
//=============================================================================
char * CStarter::GetLineTop(char * pSrc)
{
	while (1)
	{// 有効な文字列が見つかるまで回す
...
// 文字列を抜き出す
//=============================================================================
int CStarter::PopString(char * pSrc, char * pDest)
{
	int Word = 0;
