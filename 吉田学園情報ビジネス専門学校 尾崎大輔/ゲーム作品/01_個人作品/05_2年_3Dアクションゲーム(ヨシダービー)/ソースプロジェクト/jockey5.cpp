...
#define JOCKEY_SPEED	(0.75f)
//=============================================================================
// 変数
//=============================================================================
CJockey5::KEY CJockey5::m_aKeyOffset[MAX_PARTS] = {};

int	CJockey5::m_nNumParts = {};
int	CJockey5::m_nNumModel = {};
CMeshOrbit*CJockey5::m_mesh;
CJockey5::KEY_INFO*CJockey5::m_pKeyInfo[MAX_PARTS] = {};
CJockey5::MOTION_INFO CJockey5::m_aMotionInfo[MAX_PARTS] = {};

//=============================================================================
// 静的メンバ-変数宣言
//=============================================================================
LPDIRECT3DTEXTURE9 CJockey5::m_pTexture = NULL;				// テクスチャ
LPD3DXBUFFER CJockey5::m_pBuffMatModel[MAX_PARTS] = {};		// バッファ
DWORD CJockey5::m_nNumMatModel[MAX_PARTS] = {};			    // マテリアル情報の数
LPD3DXMESH CJockey5::m_pMeshModel[MAX_PARTS] = {};			// メッシュ情報へのポインタ
D3DXVECTOR3	CJockey5::m_pos = D3DXVECTOR3(0, 0, 0);			// 位置
D3DXVECTOR3 CJockey5::m_rot = D3DXVECTOR3(0, 0, 0);			// 向き
char CJockey5::m_aFileNameModel[MAX_PARTS][256] = {};
CModel*CJockey5::m_apModel[MAX_PARTS] = {};
int CJockey5::m_aIndexParent[MAX_PARTS] = {};
CJockey5::JOCKEYSTATE CJockey5::m_State = CJockey5::JOCKEYSTATE_NONE;
CJockey5::JOCKEYTYPE CJockey5::m_nType = CJockey5::JOCKEYTYPE_NONE;
//=============================================================================
// 読み込み
//=============================================================================
HRESULT CJockey5::Load(void)
{
	// デバイスを取得
...
// コンストラクタ
//=============================================================================
CJockey5::CJockey5(int nPriority, OBJTYPE objtype) :CScene(1, OBJTYPE_PLAYER)
{
	m_nCntA = 0;
	m_nCntB = 0;
	...
	m_State = CJockey5::JOCKEYSTATE_NONE;
	m_nMotionType = 0;
	m_Titlecnt = 0;
}
...
void CJockey5::Update(void)
{
	...
	m_pos = CHorse5::Getpos();
	m_rot = CHorse5::Getrot();
	...
	case JOCKEYTYPE_GAME:
		...
		// ブレーキ
		//========================================================
		if (InputKeyboard->GetPress(DIK_SPACE) == true && m_bBrake == false)
		{
			// フラグをtrueに
			m_bBrake = true;
...
// プレイヤーの生成
//=============================================================================
CJockey5 *CJockey5::Create(D3DXVECTOR3 pos, D3DXVECTOR3 rot, CJockey5::JOCKEYTYPE type)
{
	CJockey5 *pPlayer = NULL;

	if (pPlayer == NULL)
	{
		pPlayer = new CJockey5(1);
...
// プレイヤーのポジション取得
//=============================================================================
D3DXVECTOR3 CJockey5::GetPlayerpos(D3DXVECTOR3 pos)
{
	m_pos = pos;
...
// プレイヤーの位置取得
//=============================================================================
D3DXVECTOR3 CJockey5::Getpos(void)
{
	return m_pos;
}
...
// プレイヤーの向き取得
//=============================================================================
D3DXVECTOR3 CJockey5::Getrot(void)
{
	return m_rot;
}
...
// プレイヤーの動き取得
//=============================================================================
D3DXVECTOR3 CJockey5::Getmove(void)
{
	return m_move;
}
...
// モーションの更新処理
//=============================================================================
void CJockey5::UpdateMotion(void)
{
...
// 1行分(256)の読み込み
//=============================================================================
char * CJockey5::ReadLine(FILE *pFile, char * pDest)
{
	// 1行分(256文字分)読み込み)
	while (1)
	{// 有効な文字列が見つかるまで回す
...
// 文字列の先頭を取得
//=============================================================================
char * CJockey5::GetLineTop(char * pSrc)
{
	while (1)
	{// 有効な文字列が見つかるまで回す
...
// 文字列を抜き出す
//=============================================================================
int CJockey5::PopString(char * pSrc, char * pDest)
{
	int Word = 0;
