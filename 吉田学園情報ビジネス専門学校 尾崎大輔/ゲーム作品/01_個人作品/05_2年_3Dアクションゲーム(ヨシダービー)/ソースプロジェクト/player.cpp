...
#define UMA_SPEED	(1.25f)
//=============================================================================
// 変数
//=============================================================================
CPlayer::KEY CPlayer::m_aKeyOffset[MAX_PARTS] = {};

int	CPlayer::m_nNumParts = {};
int	CPlayer::m_nNumModel = {};
CMeshOrbit*CPlayer::m_mesh;
CPlayer::KEY_INFO*CPlayer::m_pKeyInfo[MAX_PARTS] = {};
CPlayer::MOTION_INFO CPlayer::m_aMotionInfo[MAX_PARTS] = {};

//=============================================================================
// 静的メンバ-変数宣言
//=============================================================================
LPDIRECT3DTEXTURE9 CPlayer::m_pTexture = NULL;				// テクスチャ
LPD3DXBUFFER CPlayer::m_pBuffMatModel[MAX_PARTS] = {};		// バッファ
DWORD CPlayer::m_nNumMatModel[MAX_PARTS] = {};			    // マテリアル情報の数
LPD3DXMESH CPlayer::m_pMeshModel[MAX_PARTS] = {};			// メッシュ情報へのポインタ
D3DXVECTOR3	CPlayer::m_pos = D3DXVECTOR3(0, 0, 0);			// 位置
D3DXVECTOR3 CPlayer::m_rot = D3DXVECTOR3(0, 0, 0);
char CPlayer::m_aFileNameModel[MAX_PARTS][256] = {};
CModel*CPlayer::m_apModel[MAX_PARTS] = {};
int CPlayer::m_aIndexParent[MAX_PARTS] = {};
CPlayer::PLAYERSTATE CPlayer::m_State = CPlayer::PLAYERSTATE_NONE;
CPlayer::JOCKEYTYPE CPlayer::m_nType = CPlayer::JOCKEYTYPE_NONE;
...
// コンストラクタ
//=============================================================================
CPlayer::CPlayer(int nPriority, OBJTYPE objtype) :CScene(1,OBJTYPE_PLAYER)
{
	m_nCntA = 0;
	m_nCntB = 0;
	...
	m_State = CPlayer::PLAYERSTATE_NONE;
	m_nMotionType = 0;
	m_Goaltimer = 0;
}
...
void CPlayer::Update(void)
{
	...
	case JOCKEYTYPE_GAME:
		...
		if (m_pos.z >= 0)
		{
			m_pos.z += UMA_SPEED + +rand() % 4 * 0.1f;

			if (InputKeyboard->GetTrigger(DIK_RETURN) == true && m_bBrake == false || InputJoypad->GetTrigger(CInputjoypad::DIJS_BOTTON_LB) == true
				|| InputJoypad->GetTrigger(CInputjoypad::DIJS_BOTTON_RB) == true || InputJoypad->GetTrigger(CInputjoypad::DIJS_BOTTON_A) == true)
			{
				m_pos.z += 2.0f;
...
// プレイヤーの生成
//=============================================================================
CPlayer *CPlayer::Create(D3DXVECTOR3 pos, D3DXVECTOR3 rot, CPlayer::JOCKEYTYPE type)
{
	CPlayer *pPlayer = NULL;

	if (pPlayer == NULL)
	{
		pPlayer = new CPlayer(1);
...
// プレイヤーのポジション取得
//=============================================================================
D3DXVECTOR3 CPlayer::GetPlayerpos(D3DXVECTOR3 pos)
{
	m_pos = pos;
...
// 1行分(256)の読み込み
//=============================================================================
char * CPlayer::ReadLine(FILE *pFile, char * pDest)
{
	// 1行分(256文字分)読み込み)
	while (1)
	{// 有効な文字列が見つかるまで回す
...
// 文字列を抜き出す
//=============================================================================
int CPlayer::PopString(char * pSrc, char * pDest)
{
	int Word = 0;
