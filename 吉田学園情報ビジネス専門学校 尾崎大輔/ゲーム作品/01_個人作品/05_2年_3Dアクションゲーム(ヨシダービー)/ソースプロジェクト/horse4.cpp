...
#define FAILE_NAME	"data\\TEXT\\umamotion4.txt"	// 読み込むtext名
#define UMA_SPEED	(1.03f)
//=============================================================================
// 変数
//=============================================================================
CHorse4::KEY CHorse4::m_aKeyOffset[MAX_PARTS] = {};

int	CHorse4::m_nNumParts = {};
int	CHorse4::m_nNumModel = {};
CMeshOrbit*CHorse4::m_mesh;
CHorse4::KEY_INFO*CHorse4::m_pKeyInfo[MAX_PARTS] = {};
CHorse4::MOTION_INFO CHorse4::m_aMotionInfo[MAX_PARTS] = {};

//=============================================================================
// 静的メンバ-変数宣言
//=============================================================================
LPDIRECT3DTEXTURE9 CHorse4::m_pTexture = NULL;				// テクスチャ
LPD3DXBUFFER CHorse4::m_pBuffMatModel[MAX_PARTS] = {};		// バッファ
DWORD CHorse4::m_nNumMatModel[MAX_PARTS] = {};			    // マテリアル情報の数
LPD3DXMESH CHorse4::m_pMeshModel[MAX_PARTS] = {};			// メッシュ情報へのポインタ
D3DXVECTOR3	CHorse4::m_pos = D3DXVECTOR3(0, 0, 0);			// 位置
D3DXVECTOR3 CHorse4::m_rot = D3DXVECTOR3(0, 0, 0);			// 向き
char CHorse4::m_aFileNameModel[MAX_PARTS][256] = {};
CModel*CHorse4::m_apModel[MAX_PARTS] = {};
int CHorse4::m_aIndexParent[MAX_PARTS] = {};
CHorse4::PLAYERSTATE CHorse4::m_State = CHorse4::PLAYERSTATE_NONE;
CHorse4::JOCKEYTYPE CHorse4::m_nType = CHorse4::JOCKEYTYPE_NONE;

//=============================================================================
// 読み込み
//=============================================================================
HRESULT CHorse4::Load(void)
{
	// デバイスを取得
...
// コンストラクタ
//=============================================================================
CHorse4::CHorse4(int nPriority, OBJTYPE objtype) :CScene(1, OBJTYPE_PLAYER)
{
	m_nCntA = 0;
	m_nCntB = 0;
	...
	m_State = CHorse4::PLAYERSTATE_NONE;
	m_nMotionType = 0;
}
...
// プレイヤーの生成
//=============================================================================
CHorse4 *CHorse4::Create(D3DXVECTOR3 pos, D3DXVECTOR3 rot, CHorse4::JOCKEYTYPE type)
{
	CHorse4 *pPlayer = NULL;

	if (pPlayer == NULL)
	{
		pPlayer = new CHorse4(1);
...
// プレイヤーのポジション取得
//=============================================================================
D3DXVECTOR3 CHorse4::GetPlayerpos(D3DXVECTOR3 pos)
{
	m_pos = pos;
...
// プレイヤーの位置取得
//=============================================================================
D3DXVECTOR3 CHorse4::Getpos(void)
{
	return m_pos;
}
...
// プレイヤーの向き取得
//=============================================================================
D3DXVECTOR3 CHorse4::Getrot(void)
{
	return m_rot;
}
...
// プレイヤーの動き取得
//=============================================================================
D3DXVECTOR3 CHorse4::Getmove(void)
{
	return m_move;
}
...
// モーションの更新処理
//=============================================================================
void CHorse4::UpdateMotion(void)
{
...
// 1行分(256)の読み込み
//=============================================================================
char * CHorse4::ReadLine(FILE *pFile, char * pDest)
{
	// 1行分(256文字分)読み込み)
	while (1)
	{// 有効な文字列が見つかるまで回す
...
// 文字列の先頭を取得
//=============================================================================
char * CHorse4::GetLineTop(char * pSrc)
{
	while (1)
	{// 有効な文字列が見つかるまで回す
...
// 文字列を抜き出す
//=============================================================================
int CHorse4::PopString(char * pSrc, char * pDest)
{
	int Word = 0;
