...
public:
	...
	CJockey8(int nPriority = 1, OBJTYPE objtype = OBJTYPE_PLAYER);
	~CJockey8();
	...
	void	Draw(void);									// 描画処理
	static CJockey8 *Create(D3DXVECTOR3 pos, D3DXVECTOR3 rot, JOCKEYTYPE type);			// 生成処理
