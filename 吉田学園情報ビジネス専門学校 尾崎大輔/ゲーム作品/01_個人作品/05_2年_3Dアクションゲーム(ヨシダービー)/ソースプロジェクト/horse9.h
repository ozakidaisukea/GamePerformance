...
public:
	...
	CHorse9(int nPriority = 1, OBJTYPE objtype = OBJTYPE_PLAYER);
	~CHorse9();
	...
	void	Draw(void);									// 描画処理
	static CHorse9 *Create(D3DXVECTOR3 pos, D3DXVECTOR3 rot, JOCKEYTYPE type);			// 生成処理
