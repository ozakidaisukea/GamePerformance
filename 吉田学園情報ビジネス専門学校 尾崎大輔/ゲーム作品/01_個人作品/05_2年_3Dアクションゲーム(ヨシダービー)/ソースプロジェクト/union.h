...
public:
	...
	typedef enum
	{
		UNIONSTATE_NONE = 0,		//初期状態
		UNIONSTATE_NORMAL,			//通常
		UNIONSTATE_MAX,			//最大数
	}UNIONSTATE;
	...
	CUnion(int nPriority = 1, OBJTYPE objtype = OBJTYPE_PLAYER);
	~CUnion();
	...
	void	Draw(void);									// 描画処理
	static CUnion *Create(D3DXVECTOR3 pos,D3DXVECTOR3 rot);		// 生成処理
