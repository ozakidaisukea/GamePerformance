...
#define JOCKEY_SPEED	(0.79f)
//=============================================================================
// 変数
//=============================================================================
CJockey9::KEY CJockey9::m_aKeyOffset[MAX_PARTS] = {};

int	CJockey9::m_nNumParts = {};
int	CJockey9::m_nNumModel = {};
CMeshOrbit*CJockey9::m_mesh;
CJockey9::KEY_INFO*CJockey9::m_pKeyInfo[MAX_PARTS] = {};
CJockey9::MOTION_INFO CJockey9::m_aMotionInfo[MAX_PARTS] = {};

//=============================================================================
// 静的メンバ-変数宣言
//=============================================================================
LPDIRECT3DTEXTURE9 CJockey9::m_pTexture = NULL;				// テクスチャ
LPD3DXBUFFER CJockey9::m_pBuffMatModel[MAX_PARTS] = {};		// バッファ
DWORD CJockey9::m_nNumMatModel[MAX_PARTS] = {};			    // マテリアル情報の数
LPD3DXMESH CJockey9::m_pMeshModel[MAX_PARTS] = {};			// メッシュ情報へのポインタ
D3DXVECTOR3	CJockey9::m_pos = D3DXVECTOR3(0, 0, 0);			// 位置
D3DXVECTOR3 CJockey9::m_rot = D3DXVECTOR3(0, 0, 0);			// 向き
char CJockey9::m_aFileNameModel[MAX_PARTS][256] = {};
CModel*CJockey9::m_apModel[MAX_PARTS] = {};
int CJockey9::m_aIndexParent[MAX_PARTS] = {};
CJockey9::JOCKEYSTATE CJockey9::m_State = CJockey9::JOCKEYSTATE_NONE;
CJockey9::JOCKEYTYPE CJockey9::m_nType = CJockey9::JOCKEYTYPE_NONE;

//=============================================================================
// 読み込み
//=============================================================================
HRESULT CJockey9::Load(void)
{
	// デバイスを取得
...
// コンストラクタ
//=============================================================================
CJockey9::CJockey9(int nPriority, OBJTYPE objtype) :CScene(1, OBJTYPE_PLAYER)
{
	m_nCntA = 0;
	m_nCntB = 0;
	...
	m_State = CJockey9::JOCKEYSTATE_NONE;
	m_nMotionType = 0;
}
...
void CJockey9::Update(void)
{
	...
	m_pos = CHorse9::Getpos();
	m_rot = CHorse9::Getrot();
...
// プレイヤーの生成
//=============================================================================
CJockey9 *CJockey9::Create(D3DXVECTOR3 pos, D3DXVECTOR3 rot, CJockey9::JOCKEYTYPE type)
{
	CJockey9 *pPlayer = NULL;

	if (pPlayer == NULL)
	{
		pPlayer = new CJockey9(1);
...
// プレイヤーのポジション取得
//=============================================================================
D3DXVECTOR3 CJockey9::GetPlayerpos(D3DXVECTOR3 pos)
{
	m_pos = pos;
...
// プレイヤーの位置取得
//=============================================================================
D3DXVECTOR3 CJockey9::Getpos(void)
{
	return m_pos;
}
...
// プレイヤーの向き取得
//=============================================================================
D3DXVECTOR3 CJockey9::Getrot(void)
{
	return m_rot;
}
...
// プレイヤーの動き取得
//=============================================================================
D3DXVECTOR3 CJockey9::Getmove(void)
{
	return m_move;
}
...
// モーションの更新処理
//=============================================================================
void CJockey9::UpdateMotion(void)
{
...
// 1行分(256)の読み込み
//=============================================================================
char * CJockey9::ReadLine(FILE *pFile, char * pDest)
{
	// 1行分(256文字分)読み込み)
	while (1)
	{// 有効な文字列が見つかるまで回す
...
// 文字列の先頭を取得
//=============================================================================
char * CJockey9::GetLineTop(char * pSrc)
{
	while (1)
	{// 有効な文字列が見つかるまで回す
...
// 文字列を抜き出す
//=============================================================================
int CJockey9::PopString(char * pSrc, char * pDest)
{
	int Word = 0;
