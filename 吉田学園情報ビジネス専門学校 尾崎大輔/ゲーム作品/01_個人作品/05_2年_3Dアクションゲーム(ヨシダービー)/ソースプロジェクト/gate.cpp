...
// 変数
//=============================================================================
CGate::KEY CGate::m_aKeyOffset[MAX_PARTS] = {};

int	CGate::m_nNumParts = {};
int	CGate::m_nNumModel = {};
CMeshOrbit*CGate::m_mesh;
CGate::KEY_INFO*CGate::m_pKeyInfo[MAX_PARTS] = {};
CGate::MOTION_INFO CGate::m_aMotionInfo[MAX_PARTS] = {};

//=============================================================================
// 静的メンバ-変数宣言
//=============================================================================
LPDIRECT3DTEXTURE9 CGate::m_pTexture = NULL;				// テクスチャ
LPD3DXBUFFER CGate::m_pBuffMatModel[MAX_PARTS] = {};		// バッファ
DWORD CGate::m_nNumMatModel[MAX_PARTS] = {};			    // マテリアル情報の数
LPD3DXMESH CGate::m_pMeshModel[MAX_PARTS] = {};				// メッシュ情報へのポインタ
D3DXVECTOR3	CGate::m_pos = D3DXVECTOR3(0, 0, 0);			// 位置
D3DXVECTOR3 CGate::m_rot = D3DXVECTOR3(0, 0, 0);			// 向き
CModel*CGate::m_apModel[MAX_PARTS] = {};
char CGate::m_aFileNameModel[MAX_PARTS][256] = {};
int CGate::m_aIndexParent[MAX_PARTS] = {};
CGate::GATESTATE CGate::m_State = CGate::GATESTATE_NONE;
...
// コンストラクタ
//=============================================================================
CGate::CGate(int nPriority, OBJTYPE objtype) :CScene(1, OBJTYPE_PLAYER)
{
...
// ゲートの生成
//=============================================================================
CGate *CGate::Create(D3DXVECTOR3 pos,GATE_TYPE type)
{
	CGate *pGate = NULL;
...
// 動き取得
//=============================================================================
D3DXVECTOR3 CGate::Getmove(void)
{
	return m_move;
}
...
// 1行分(256)の読み込み
//=============================================================================
char * CGate::ReadLine(FILE *pFile, char * pDest)
{
	// 1行分(256文字分)読み込み)
	while (1)
	{// 有効な文字列が見つかるまで回す
...
// 文字列の先頭を取得
//=============================================================================
char * CGate::GetLineTop(char * pSrc)
{
	while (1)
	{// 有効な文字列が見つかるまで回す
...
// 文字列を抜き出す
//=============================================================================
int CGate::PopString(char * pSrc, char * pDest)
{
	int Word = 0;
