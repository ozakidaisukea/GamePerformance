...
#define JOCKEY_SPEED	(0.76f)

//=============================================================================
// 変数
//=============================================================================
CJockey6::KEY CJockey6::m_aKeyOffset[MAX_PARTS] = {};

int	CJockey6::m_nNumParts = {};
int	CJockey6::m_nNumModel = {};
CMeshOrbit*CJockey6::m_mesh;
CJockey6::KEY_INFO*CJockey6::m_pKeyInfo[MAX_PARTS] = {};
CJockey6::MOTION_INFO CJockey6::m_aMotionInfo[MAX_PARTS] = {};

//=============================================================================
// 静的メンバ-変数宣言
//=============================================================================
LPDIRECT3DTEXTURE9 CJockey6::m_pTexture = NULL;				// テクスチャ
LPD3DXBUFFER CJockey6::m_pBuffMatModel[MAX_PARTS] = {};		// バッファ
DWORD CJockey6::m_nNumMatModel[MAX_PARTS] = {};			    // マテリアル情報の数
LPD3DXMESH CJockey6::m_pMeshModel[MAX_PARTS] = {};			// メッシュ情報へのポインタ
D3DXVECTOR3	CJockey6::m_pos = D3DXVECTOR3(0, 0, 0);			// 位置
D3DXVECTOR3 CJockey6::m_rot = D3DXVECTOR3(0, 0, 0);			// 向き
char CJockey6::m_aFileNameModel[MAX_PARTS][256] = {};
CModel*CJockey6::m_apModel[MAX_PARTS] = {};
int CJockey6::m_aIndexParent[MAX_PARTS] = {};
CJockey6::JOCKEYSTATE CJockey6::m_State = CJockey6::JOCKEYSTATE_NONE;
CJockey6::JOCKEYTYPE CJockey6::m_nType = CJockey6::JOCKEYTYPE_NONE;
//=============================================================================
// 読み込み
//=============================================================================
HRESULT CJockey6::Load(void)
{
	// デバイスを取得
...
// コンストラクタ
//=============================================================================
CJockey6::CJockey6(int nPriority, OBJTYPE objtype) :CScene(1, OBJTYPE_PLAYER)
{
	m_nCntA = 0;
	m_nCntB = 0;
	...
	m_State = CJockey6::JOCKEYSTATE_NONE;
	m_nMotionType = 0;
}
...
void CJockey6::Update(void)
{
	...
	m_pos = CHorse6::Getpos();
	m_rot = CHorse6::Getrot();
...
// プレイヤーの生成
//=============================================================================
CJockey6 *CJockey6::Create(D3DXVECTOR3 pos, D3DXVECTOR3 rot, CJockey6::JOCKEYTYPE type)
{
	CJockey6 *pPlayer = NULL;

	if (pPlayer == NULL)
	{
		pPlayer = new CJockey6(1);
...
// プレイヤーのポジション取得
//=============================================================================
D3DXVECTOR3 CJockey6::GetPlayerpos(D3DXVECTOR3 pos)
{
	m_pos = pos;
...
// プレイヤーの位置取得
//=============================================================================
D3DXVECTOR3 CJockey6::Getpos(void)
{
	return m_pos;
}
...
// プレイヤーの向き取得
//=============================================================================
D3DXVECTOR3 CJockey6::Getrot(void)
{
	return m_rot;
}
...
// プレイヤーの動き取得
//=============================================================================
D3DXVECTOR3 CJockey6::Getmove(void)
{
	return m_move;
}
...
// モーションの更新処理
//=============================================================================
void CJockey6::UpdateMotion(void)
{
...
// 1行分(256)の読み込み
//=============================================================================
char * CJockey6::ReadLine(FILE *pFile, char * pDest)
{
	// 1行分(256文字分)読み込み)
	while (1)
	{// 有効な文字列が見つかるまで回す
...
// 文字列の先頭を取得
//=============================================================================
char * CJockey6::GetLineTop(char * pSrc)
{
	while (1)
	{// 有効な文字列が見つかるまで回す
...
// 文字列を抜き出す
//=============================================================================
int CJockey6::PopString(char * pSrc, char * pDest)
{
	int Word = 0;
