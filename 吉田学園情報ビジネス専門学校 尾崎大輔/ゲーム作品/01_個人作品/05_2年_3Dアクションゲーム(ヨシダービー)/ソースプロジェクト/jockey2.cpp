...
#define JOCKEY_SPEED	(0.72f)
//=============================================================================
// 変数
//=============================================================================
CJockey2::KEY CJockey2::m_aKeyOffset[MAX_PARTS] = {};

int	CJockey2::m_nNumParts = {};
int	CJockey2::m_nNumModel = {};
CMeshOrbit*CJockey2::m_mesh;
CJockey2::KEY_INFO*CJockey2::m_pKeyInfo[MAX_PARTS] = {};
CJockey2::MOTION_INFO CJockey2::m_aMotionInfo[MAX_PARTS] = {};

//=============================================================================
// 静的メンバ-変数宣言
//=============================================================================
LPDIRECT3DTEXTURE9 CJockey2::m_pTexture = NULL;				// テクスチャ
LPD3DXBUFFER CJockey2::m_pBuffMatModel[MAX_PARTS] = {};		// バッファ
DWORD CJockey2::m_nNumMatModel[MAX_PARTS] = {};			    // マテリアル情報の数
LPD3DXMESH CJockey2::m_pMeshModel[MAX_PARTS] = {};			// メッシュ情報へのポインタ
D3DXVECTOR3	CJockey2::m_pos = D3DXVECTOR3(0, 0, 0);			// 位置
D3DXVECTOR3 CJockey2::m_rot = D3DXVECTOR3(0, 0, 0);			// 向き
char CJockey2::m_aFileNameModel[MAX_PARTS][256] = {};
CModel*CJockey2::m_apModel[MAX_PARTS] = {};
int CJockey2::m_aIndexParent[MAX_PARTS] = {};
CJockey2::JOCKEYSTATE CJockey2::m_State = CJockey2::JOCKEYSTATE_NONE;
CJockey2::JOCKEYTYPE CJockey2::m_nType = CJockey2::JOCKEYTYPE_NONE;
//=============================================================================
// 読み込み
//=============================================================================
HRESULT CJockey2::Load(void)
{
	// デバイスを取得
...
// コンストラクタ
//=============================================================================
CJockey2::CJockey2(int nPriority, OBJTYPE objtype) :CScene(1, OBJTYPE_PLAYER)
{
	m_nCntA = 0;
	m_nCntB = 0;
	...
	m_State = CJockey2::JOCKEYSTATE_NONE;
	m_nMotionType = 0;
}
...
void CJockey2::Update(void)
{
	...
	m_pos = CHorse2::Getpos();
	m_rot = CHorse2::Getrot();
...
// プレイヤーの生成
//=============================================================================
CJockey2 *CJockey2::Create(D3DXVECTOR3 pos,D3DXVECTOR3 rot,CJockey2::JOCKEYTYPE type)
{
	CJockey2 *pPlayer = NULL;

	if (pPlayer == NULL)
	{
		pPlayer = new CJockey2(1);
...
// プレイヤーのポジション取得
//=============================================================================
D3DXVECTOR3 CJockey2::GetPlayerpos(D3DXVECTOR3 pos)
{
	m_pos = pos;
...
// プレイヤーの位置取得
//=============================================================================
D3DXVECTOR3 CJockey2::Getpos(void)
{
	return m_pos;
}
...
// プレイヤーの向き取得
//=============================================================================
D3DXVECTOR3 CJockey2::Getrot(void)
{
	return m_rot;
}
...
// プレイヤーの動き取得
//=============================================================================
D3DXVECTOR3 CJockey2::Getmove(void)
{
	return m_move;
}
...
// モーションの更新処理
//=============================================================================
void CJockey2::UpdateMotion(void)
{
...
// 1行分(256)の読み込み
//=============================================================================
char * CJockey2::ReadLine(FILE *pFile, char * pDest)
{
	// 1行分(256文字分)読み込み)
	while (1)
	{// 有効な文字列が見つかるまで回す
...
// 文字列の先頭を取得
//=============================================================================
char * CJockey2::GetLineTop(char * pSrc)
{
	while (1)
	{// 有効な文字列が見つかるまで回す
...
// 文字列を抜き出す
//=============================================================================
int CJockey2::PopString(char * pSrc, char * pDest)
{
	int Word = 0;
