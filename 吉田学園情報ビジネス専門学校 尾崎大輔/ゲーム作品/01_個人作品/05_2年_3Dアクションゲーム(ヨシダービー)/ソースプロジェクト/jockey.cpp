...
#define JOCKEY_SPEED	(0.71f)
//=============================================================================
// 変数
//=============================================================================
CJockey::KEY CJockey::m_aKeyOffset[MAX_PARTS] = {};

int	CJockey::m_nNumParts = {};
int	CJockey::m_nNumModel = {};
CMeshOrbit*CJockey::m_mesh;
CJockey::KEY_INFO*CJockey::m_pKeyInfo[MAX_PARTS] = {};
CJockey::MOTION_INFO CJockey::m_aMotionInfo[MAX_PARTS] = {};

//=============================================================================
// 静的メンバ-変数宣言
//=============================================================================
LPDIRECT3DTEXTURE9 CJockey::m_pTexture = NULL;				// テクスチャ
LPD3DXBUFFER CJockey::m_pBuffMatModel[MAX_PARTS] = {};		// バッファ
DWORD CJockey::m_nNumMatModel[MAX_PARTS] = {};			    // マテリアル情報の数
LPD3DXMESH CJockey::m_pMeshModel[MAX_PARTS] = {};			// メッシュ情報へのポインタ
D3DXVECTOR3	CJockey::m_pos = D3DXVECTOR3(0, 0, 0);			// 位置
D3DXVECTOR3 CJockey::m_rot = D3DXVECTOR3(0, 0, 0);			// 向き
char CJockey::m_aFileNameModel[MAX_PARTS][256] = {};
CModel*CJockey::m_apModel[MAX_PARTS] = {};
int CJockey::m_aIndexParent[MAX_PARTS] = {};
CJockey::JOCKEYSTATE CJockey::m_State = CJockey::JOCKEYSTATE_NONE;
CJockey::JOCKEYTYPE CJockey::m_nType = CJockey::JOCKEYTYPE_NONE;
//=============================================================================
// 読み込み
//=============================================================================
HRESULT CJockey::Load(void)
{
	// デバイスを取得
...
// コンストラクタ
//=============================================================================
CJockey::CJockey(int nPriority, OBJTYPE objtype) :CScene(1, OBJTYPE_PLAYER)
{
	m_nCntA = 0;
	m_nCntB = 0;
	...
	m_State = CJockey::JOCKEYSTATE_NONE;
	m_nMotionType = 0;
}
...
// プレイヤーの生成
//=============================================================================
CJockey *CJockey::Create(D3DXVECTOR3 pos,D3DXVECTOR3 rot,CJockey::JOCKEYTYPE type)
{
	CJockey *pPlayer = NULL;

	if (pPlayer == NULL)
	{
		pPlayer = new CJockey(1);
...
// プレイヤーのポジション取得
//=============================================================================
D3DXVECTOR3 CJockey::GetPlayerpos(D3DXVECTOR3 pos)
{
	m_pos = pos;
...
// プレイヤーの位置取得
//=============================================================================
D3DXVECTOR3 CJockey::Getpos(void)
{
	return m_pos;
}
...
// プレイヤーの向き取得
//=============================================================================
D3DXVECTOR3 CJockey::Getrot(void)
{
	return m_rot;
}
...
// プレイヤーの動き取得
//=============================================================================
D3DXVECTOR3 CJockey::Getmove(void)
{
	return m_move;
}
...
// モーションの更新処理
//=============================================================================
void CJockey::UpdateMotion(void)
{
...
// 1行分(256)の読み込み
//=============================================================================
char * CJockey::ReadLine(FILE *pFile, char * pDest)
{
	// 1行分(256文字分)読み込み)
	while (1)
	{// 有効な文字列が見つかるまで回す
...
// 文字列の先頭を取得
//=============================================================================
char * CJockey::GetLineTop(char * pSrc)
{
	while (1)
	{// 有効な文字列が見つかるまで回す
...
// 文字列を抜き出す
//=============================================================================
int CJockey::PopString(char * pSrc, char * pDest)
{
	int Word = 0;
