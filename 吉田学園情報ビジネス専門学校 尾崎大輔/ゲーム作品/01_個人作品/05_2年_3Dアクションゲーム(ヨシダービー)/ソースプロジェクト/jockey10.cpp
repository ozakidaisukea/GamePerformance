...
#define JOCKEY_SPEED	(0.8f)
//=============================================================================
// 変数
//=============================================================================
CJockey10::KEY CJockey10::m_aKeyOffset[MAX_PARTS] = {};

int	CJockey10::m_nNumParts = {};
int	CJockey10::m_nNumModel = {};
CMeshOrbit*CJockey10::m_mesh;
CJockey10::KEY_INFO*CJockey10::m_pKeyInfo[MAX_PARTS] = {};
CJockey10::MOTION_INFO CJockey10::m_aMotionInfo[MAX_PARTS] = {};

//=============================================================================
// 静的メンバ-変数宣言
//=============================================================================
LPDIRECT3DTEXTURE9 CJockey10::m_pTexture = NULL;				// テクスチャ
LPD3DXBUFFER CJockey10::m_pBuffMatModel[MAX_PARTS] = {};		// バッファ
DWORD CJockey10::m_nNumMatModel[MAX_PARTS] = {};			    // マテリアル情報の数
LPD3DXMESH CJockey10::m_pMeshModel[MAX_PARTS] = {};				// メッシュ情報へのポインタ
D3DXVECTOR3	CJockey10::m_pos = D3DXVECTOR3(0, 0, 0);			// 位置
D3DXVECTOR3 CJockey10::m_rot = D3DXVECTOR3(0, 0, 0);			// 向き
char CJockey10::m_aFileNameModel[MAX_PARTS][256] = {};
CModel*CJockey10::m_apModel[MAX_PARTS] = {};
int CJockey10::m_aIndexParent[MAX_PARTS] = {};
CJockey10::JOCKEYSTATE CJockey10::m_State = CJockey10::JOCKEYSTATE_NONE;
CJockey10::JOCKEYTYPE CJockey10::m_nType = CJockey10::JOCKEYTYPE_NONE;

//=============================================================================
// 読み込み
//=============================================================================
HRESULT CJockey10::Load(void)
{
	// デバイスを取得
...
// コンストラクタ
//=============================================================================
CJockey10::CJockey10(int nPriority, OBJTYPE objtype) :CScene(1, OBJTYPE_PLAYER)
{
	m_nCntA = 0;
	m_nCntB = 0;
	...
	m_State = CJockey10::JOCKEYSTATE_NONE;
	m_nMotionType = 0;
}
...
void CJockey10::Update(void)
{
	...
	m_pos = CHorse10::Getpos();
	m_rot = CHorse10::Getrot();
...
// プレイヤーの生成
//=============================================================================
CJockey10 *CJockey10::Create(D3DXVECTOR3 pos, D3DXVECTOR3 rot, CJockey10::JOCKEYTYPE type)
{
	CJockey10 *pPlayer = NULL;

	if (pPlayer == NULL)
	{
		pPlayer = new CJockey10(1);
...
// プレイヤーのポジション取得
//=============================================================================
D3DXVECTOR3 CJockey10::GetPlayerpos(D3DXVECTOR3 pos)
{
	m_pos = pos;
...
// プレイヤーの位置取得
//=============================================================================
D3DXVECTOR3 CJockey10::Getpos(void)
{
	return m_pos;
}
...
// プレイヤーの向き取得
//=============================================================================
D3DXVECTOR3 CJockey10::Getrot(void)
{
	return m_rot;
}
...
// プレイヤーの動き取得
//=============================================================================
D3DXVECTOR3 CJockey10::Getmove(void)
{
	return m_move;
}
...
// モーションの更新処理
//=============================================================================
void CJockey10::UpdateMotion(void)
{
...
// 1行分(256)の読み込み
//=============================================================================
char * CJockey10::ReadLine(FILE *pFile, char * pDest)
{
	// 1行分(256文字分)読み込み)
	while (1)
	{// 有効な文字列が見つかるまで回す
...
// 文字列の先頭を取得
//=============================================================================
char * CJockey10::GetLineTop(char * pSrc)
{
	while (1)
	{// 有効な文字列が見つかるまで回す
...
// 文字列を抜き出す
//=============================================================================
int CJockey10::PopString(char * pSrc, char * pDest)
{
	int Word = 0;
