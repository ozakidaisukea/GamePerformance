...
void  CRenderer::Draw(void)
{
	...
	{
		if (CManager::GetLight() != NULL) { CManager::GetLight()->Set(); }
		if (CManager::GetpSpotLight() != NULL) { CManager::GetpSpotLight()->Set(); }

		if (CManager::GetCamera() != NULL) { CManager::GetCamera()->SetCamera(); }

		CScene::DrawAll(m_pD3DDevice);
